...
void Rover::send_tractor_health(mavlink_channel_t chan)
{
    mavlink_msg_tractor_health_send(
        chan,
        tractor_health_info[0], // D4 field of 0x0CF00400 256^0*D4+256^1*D5=Total Decimal
        tractor_health_info[1], // D5 field of 0x0CF00400 256^0*D4+256^1*D5=Total Decimal
        tractor_health_info[2], // D1 field of 0x18FEEE00 1degree/bit -40 offset
        tractor_health_info[3], // D4 field of 0x18FEEF00 4kpa/bit no offset
        tractor_health_info[4]); // D2 field of 0x18FEFC47 0.4%/bit no offset
}
